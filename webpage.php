...
<html lang="en">
    ...
    <body class=" ">
                        ...
                        <div class="col-md-11 col-sm-12 text-right text-left-xs text-left-sm">
                            <div class="bar__module">
                                <ul class="menu-horizontal text-left">
                                    ...
                                    <li class="dropdown">
                                        <span class="dropdown__trigger">Why Us</span>
        ...
        <div class="main-container">
            <section class="text-center height-80 imagebg" data-overlay="4">
                <div class="background-image-holder">
                    <img alt="background" src="img/construction2.jpg"  />
                </div>
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="typed-headline" style="margin-top: 25px;">
                                <span class="h1 inline-block"></span>
                                <span class="h1 inline-block typed-text typed-text--cursor color--primary" data-typed-strings="Currently Under Construction"></span>
                            </div>
                            <p class="lead">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            ...
                            <p>
                                prepclass is a robust multipurpose platform designed with modularity at the core. Easily combine over 290 trainee to create a learning path for your children.
                            </p>
                        </div>
                        <div class="col-sm-6 col-md-3">
